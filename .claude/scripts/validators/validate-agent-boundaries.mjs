...
export const validateAgentBoundaries = ({
  ...
  const cases = [
    ...
    ['Next App Router source', 'next-runtime-builder', join(repositoryRoot, 'src/app/dashboard/page.tsx'), 0],
    ['Next runtime builder package metadata', 'next-runtime-builder', join(repositoryRoot, 'package.json'), 2],
    ...
    ['client domain state output', 'client-domain-state-builder', join(repositoryRoot, 'src/entities/board/model/store.ts'), 0],
    ['client domain state builder UI source', 'client-domain-state-builder', join(repositoryRoot, 'src/widgets/board/ui/Board.tsx'), 2],
