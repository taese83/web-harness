...
export const validateAgentBoundaries = ({
  ...
  const cases = [
    ...
    ['requirements flat output', 'product-planner', join(repositoryRoot, '_workspace/01_plan/requirements.md'), 0],
    ['requirements sharded section', 'product-planner', join(repositoryRoot, '_workspace/01_plan/requirements/unified-results.md'), 0],
    ['requirements adjacent name not owned', 'product-planner', join(repositoryRoot, '_workspace/01_plan/requirements-legacy.md'), 2],
    ['ux brief sharded section', 'product-planner', join(repositoryRoot, '_workspace/01_plan/ux-brief/flows.md'), 0],
    ['ux brief adjacent name not owned', 'product-planner', join(repositoryRoot, '_workspace/01_plan/ux-brief-notes.md'), 2],
    ['decision log flat output', 'product-planner', join(repositoryRoot, '_workspace/01_plan/decision-log.md'), 0],
    ['decision log sharded range section', 'product-planner', join(repositoryRoot, '_workspace/01_plan/decision-log/PC-001~050.md'), 0],
    ['product planner cannot write the feature plan', 'product-planner', join(repositoryRoot, '_workspace/01_plan/feature-plan.md'), 2],
    ['retired planning context has no producer', 'product-planner', join(repositoryRoot, '_workspace/01_plan/planning-context.md'), 2],
    ['ingestor cannot revive the retired planning context', 'source-artifact-ingestor', join(repositoryRoot, '_workspace/01_plan/planning-context.md'), 2],
    ['retired agent cannot write its old output', 'requirements-analyst', join(repositoryRoot, '_workspace/01_plan/requirements.md'), 2],
    ...
    ['retired project brief has no producer', 'product-planner', join(repositoryRoot, '_workspace/01_plan/project-brief.md'), 2],
    ['ingestor cannot revive the retired project brief', 'source-artifact-ingestor', join(repositoryRoot, '_workspace/01_plan/project-brief.md'), 2],
