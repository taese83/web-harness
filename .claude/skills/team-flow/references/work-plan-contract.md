...
- 회귀: `test-team-e2e.mjs`(Jira)·`test-team-github-e2e.mjs`(GitHub·자동 닫기 v3)·`test-team-monorepo-e2e.mjs`(앱 접두 범위·실제 소유권 훅)·`test-team-shared-file-e2e.mjs`(같은 파일)·`test-team-revision-e2e.mjs`(5인·개정 두 번·되돌림), 모두 실제 git.
