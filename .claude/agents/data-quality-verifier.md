...
6. source/test/config는 수정하지 않고 owner를 `ingestion-contract-designer`, `external-data-pipeline-builder`, `test-writer`, `environment-scaffolder`, `deploy-ci-writer` 중 지정한다.
