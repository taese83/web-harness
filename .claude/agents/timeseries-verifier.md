...
- 실패 owner 후보: `timeseries-architect`(계약), `developer`(transport/buffer), `mock-api-builder`(fake), `developer`(historical query), `developer`/`developer`(chart UI), `test-writer`(fixture).
